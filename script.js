...
function extra_activity_cal() {
  ...
  if (hopeElite) {
    result_mark.category = 'hope_elite';
    result_mark.pt1 = parseInt(document.getElementById("he_cert").value) || 0;
    result_mark.pt2 = parseInt(document.getElementById("he_assessment").value) || 0;
    result_mark.pt3 = parseInt(document.getElementById("he_perf").value) || 0;
  } else if (pep) {
    result_mark.category = 'pep';
    result_mark.pt1 = parseInt(document.getElementById("pep_cert").value) || 0;
    result_mark.pt2 = parseInt(document.getElementById("pep_assessment").value) || 0;
    result_mark.pt3 = parseInt(document.getElementById("pep_nptel").value) || 0;
  } else {
    result_mark.category = 'general';
    result_mark.pt1 = parseInt(document.getElementById("gen_nptel").value) || 0;
    result_mark.pt2 = parseInt(document.getElementById("gen_cert").value) || 0;
    result_mark.pt3 = parseInt(document.getElementById("gen_extra").value) || 0;
  }
}
...
function internal_mark_calculation() {
  ...
  if (result_mark.pt1) { //nptel
    result += result_mark.pt1;
  }
  if (result_mark.pt2) { //courrse (by default result_mark[4] is 0, if(0) -> false)
    result += result_mark.pt2;
  }
  if (result_mark.pt3) { //competition(extra)
...
function display_changer() {
  ...
  if (result_mark.category === 'hope_elite') {
    label1 = "CERTIFICATION"; max1 = 7;
    label2 = "ASSESSMENT"; max2 = 6;
    label3 = "PERFORMANCE"; max3 = 7;
  } else if (result_mark.category === 'pep') {
    label1 = "CERT / COURSE"; max1 = 7;
    label2 = "ASSESSMENT"; max2 = 6;
    label3 = "NPTEL"; max3 = 7;
  } else {
    label1 = "NPTEL"; max1 = 8;
    label2 = "COURSE"; max2 = 7;
    label3 = "EXTRA"; max3 = 5;
  }
...
document.getElementById("calculate_button").addEventListener("click", () => {
  ...
  if (hopeElite) {
    let pt1 = parseInt(document.getElementById("he_cert").value) || 0;
    let pt2 = parseInt(document.getElementById("he_assessment").value) || 0;
    let pt3 = parseInt(document.getElementById("he_perf").value) || 0;
    ...
    let pt1 = parseInt(document.getElementById("pep_cert").value) || 0;
    let pt2 = parseInt(document.getElementById("pep_assessment").value) || 0;
    let pt3 = parseInt(document.getElementById("pep_nptel").value) || 0;
    ...
    let pt1 = parseInt(document.getElementById("gen_nptel").value) || 0;
    let pt2 = parseInt(document.getElementById("gen_cert").value) || 0;
    let pt3 = parseInt(document.getElementById("gen_extra").value) || 0;
